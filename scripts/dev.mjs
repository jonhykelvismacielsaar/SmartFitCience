...
const cores = [
  ['api', 8787, 'node', ['--disable-warning=ExperimentalWarning', 'server/index.js']],
...
console.log('\x1b[1mSmartFit Science\x1b[0m · app http://localhost:5173 · api http://localhost:8787/api/health · base de evidência local');
